...
- [x] 2026-06-04 EDT: Implemented oscillator phase and band-limited saw/pulse.
- [x] 2026-06-04 EDT: Implemented noise and sub oscillator waveforms.
- [x] 2026-06-04 EDT: Implemented stack count, detune, and hard sync.
- [x] 2026-06-04 EDT: Implemented mixer/gain compensation.
- [x] 2026-06-04 EDT: Added oscillator render metrics.
...
Completed. `build/reports/oscillator.json` validates C1, C3, C5, and C7 tuning inside the 5-cent target; pulse duty cycle at 10, 25, 50, 75, and 90 percent widths; sub-octave accuracy for -1, -2, and -3; stack-detune symmetry; deterministic noise; hard-sync stability; and high-band spectral metrics.
