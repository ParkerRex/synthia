...
- [ ] Implement amp envelope application and amp drive.
- [ ] Implement base pan, voice spread, and unison spread.
- [ ] Implement analog instability controls.
- [ ] Build clean-room factory pluck preset and macros.
- [ ] Render dry-core musical proof.

## Surprises & Discoveries

None yet. Record gain staging, stereo correlation, analog noise, and preset tuning findings here.
