...
Product-order Codex slice after the current VST3 controller-learn proof PR: complete the remaining Ableton Phase 1 host matrix against AU/VST3 with automation record/playback, AU controller mapping, preset recreation, modulation exercise, bounce-versus-realtime comparison, buffer/sample-rate, and all-notes-off/panic proof.
