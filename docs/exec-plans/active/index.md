...
Product-order Codex slice: complete the remaining Ableton Phase 1 host matrix against AU/VST3 with automation record/playback, rendered modulation-behavior comparison beyond route visibility, and bounce-versus-realtime comparison.
