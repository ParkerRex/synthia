...
- [ ] Implement semitone cutoff conversion and clamping.
- [ ] Implement nonlinear filter stages and mode outputs.
- [ ] Implement drive/resonance compensation and self-oscillation behavior.
- [ ] Add oversampling path.
- [ ] Add filter metrics and stability tests.

## Surprises & Discoveries

None yet. Record tuning, stability, aliasing, CPU, and self-oscillation calibration discoveries here.
