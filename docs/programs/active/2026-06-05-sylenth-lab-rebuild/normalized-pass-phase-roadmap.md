...
- Ableton proof: AU/VST3 scan/load/play, automation, learned CC mapping, AU transport stop, save/reopen, preset recreation, modulation exercise, bounce-versus-realtime comparison, sample-rate/buffer-size changes, all-notes-off, panic, hosted UI open/close while playing.
