...
- UI shell and polish: faithful Sylenth visual/workflow recreation informed by screenshots/manual, implemented through Claude Code handoff after engine/state contracts exist.
