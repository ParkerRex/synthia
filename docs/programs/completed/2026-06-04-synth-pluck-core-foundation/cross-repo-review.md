...
- `docs/programs/completed/2026-06-04-synth-pluck-core-foundation/` owns initiative memory.
...
The source-use policy is stricter than a normal product build. Plans must avoid copied names, copied presets, copied UI, and binary reverse engineering.
...
- Do not let the final product name drift without updating bundle IDs, preset names, docs, and source-alignment checks.
