...
- AU and VST3 automation record/playback.
- AU seeded controller value proof plus VST3 learned-CC, continuous value-application, Forget, and stepped-controller proof later passed; AU in-editor Learn remains unproven.
- Current preset recreation and modulation exercise.
