...
- Hosted VST3 Arp Motion 01 preset editor-state proof later passed; AU preset load, playback after preset load, and Ableton-side modulation behavior exercise remain open.
