...
- `[Observed]` Preset browser local/preset metadata: favorite state is a user-library sidecar keyed as `<source>:<preset_id>`, not an audio parameter; author, description, tags, bank, and category come from preset JSON scan summaries, not APVTS automation.
