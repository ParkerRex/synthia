...
- A registry-bound editor with factory/user preset load-save-duplicate workflow, preset dirty/init/randomize/reset/A-B controls, metadata-aware Save New/Overwrite controls, TransMod slot editing, and diagnostics.
